...
const contaSchema = z.object({
  ...
  valor: z.number({ message: 'Valor inválido' }).positive('Valor deve ser positivo'),
...
export default function ContasPagarPage() {
  ...
  const contasFiltradas = useMemo(() => {
    ...
    return lista
  }, [contas, tabAtiva, categoriaFiltro, search, hoje])
  ...
  return (
    <AppShell titulo="Contas a Pagar" empresa="emporio">
      {/* Stats */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          ...
          valor={`${vencendoHoje.length} contas`}
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <Button
              ...
              className="bg-[#D4A528] hover:bg-[#B8891F] text-white border-0 h-9 px-4 text-sm shrink-0"
            >
          ...
          <form onSubmit={handleSubmit(onSubmitConta)} className="space-y-4">
            ...
            <SheetFooter className="flex gap-2">
              ...
              <Button
                type="submit"
                disabled={salvandoConta}
                className="flex-1 bg-[#D4A528] hover:bg-[#B8891F] text-white border-0"
              >
                {salvandoConta ? (
                  <>
