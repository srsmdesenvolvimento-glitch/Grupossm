...
export const VARIAVEIS_FACTORING: VariavelTemplate[] = [
  ...
  { chave: 'valor', descricao: 'Valor da parcela a pagar', exemplo: 'R$ 456,00' },
  { chave: 'valor_total', descricao: 'Total a pagar com encargos', exemplo: 'R$ 479,00' },
  { chave: 'multa', descricao: 'Multa por atraso', exemplo: 'R$ 10,00' },
  { chave: 'juros_mora', descricao: 'Juros de mora acumulados', exemplo: 'R$ 13,00' },
  ...
  { chave: 'dias_antes', descricao: 'Dias antes do vencimento', exemplo: '3' },
  { chave: 'dias_atraso', descricao: 'Dias em atraso', exemplo: '5' },
  { chave: 'whatsapp_padrao', descricao: 'Chave PIX da empresa', exemplo: '00.000.000/0001-00' },
  { chave: 'link_assinatura', descricao: 'Link para assinar o contrato', exemplo: 'https://app.srsm.com/assinar/...' },
  { chave: 'link_contrato', descricao: 'Link do contrato PDF assinado', exemplo: 'https://storage.../contrato.pdf' },
